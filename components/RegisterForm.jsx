...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div className="flex flex-col bg-white shadow-xl rounded-lg border-t-4 border-blue-600 p-12 gap-6 max-w-[90%] sm:w-[375px]">
          ...
          <form className="flex flex-col font-quicksand gap-6" onSubmit={handleSubmit}>
              <input
                  ...
                  type="text"
                  placeholder="Name"
                  className="focus:outline-none focus:border-blue-600 w-full border-2 border-gray-100 bg-gray-100 py-2 px-4"
              />
              <input
          ...
          {error && (
              <div className="font-quicksand bg-red-600 text-white py-1 px-2 rounded-lg max-w-[90%] sm:max-w-[325px] break-words">
                  <p>{error}</p>
              </div>
          )}
